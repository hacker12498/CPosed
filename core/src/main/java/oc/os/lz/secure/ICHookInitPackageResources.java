 ...
 */
public interface ICHookInitPackageResources extends ICMod {
    /**
    ...
    final class Wrapper extends XC_InitPackageResources {
        private final ICHookInitPackageResources instance;
        public Wrapper(ICHookInitPackageResources instance) {
