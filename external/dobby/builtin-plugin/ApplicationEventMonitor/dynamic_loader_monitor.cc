...
#endif
  CobbyHook((void *)DobbySymbolResolver(NULL, "__loader_dlopen"), (void *)fake_loader_dlopen,
            (void **)&orig_loader_dlopen);
#else
  CobbyHook((void *)DobbySymbolResolver(NULL, "dlopen"), (void *)fake_dlopen, (void **)&orig_dlopen);
#endif

  CobbyHook((void *)dlsym, (void *)fake_dlsym, (void **)&orig_dlsym);
  CobbyHook((void *)dlclose, (void *)fake_dlclose, (void **)&orig_dlclose);
}
#endif
